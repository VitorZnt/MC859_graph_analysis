...
The data can be found at Mendeley Data repository. As the graphml graphs were exported from Neo4J, they all have by default orientation, but that is how Neo4J works. In order to analise the User Graph as undirected, it is sufficient to run any Cypher query or processing disconsidering the orientation.
