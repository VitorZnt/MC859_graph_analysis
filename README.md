...
The processed data and graphs can be found at Mendeley Data repository (https://data.mendeley.com/datasets/rbskv4zxdd/2 with doi: 10.17632/rbskv4zxdd.2). As the graphml graphs were exported from Neo4J, they all have by default orientation, but that is how Neo4J works. In order to analyze the User Graph as undirected, it is sufficient to run any Cypher query or processing disregarding the orientation.
