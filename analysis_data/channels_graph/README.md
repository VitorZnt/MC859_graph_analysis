...
The weightless betweenness centrality was calculated with the Brandes algorithm, while the wighted one utilized multiple Djikstra iterations. Both used all nodes as samples, thus giving an exact answer. See more details at Neo4J's GDS documentation.
